<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="sidebar-sticky pt-3">
        ...
        <ul class="nav flex-column mb-2">
            <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-record-circle"></i> Brief</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-record-circle"></i> Crear Brief</a></li>
            {{-- <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-record-circle"></i> Clientes</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-record-circle"></i> Crear Cliente</a></li>
